...
public class Minecraft implements IThreadListener, IPlayerUsage
{
        ...
        while (true)
        {
            try
            {
                while (this.running)
                {
                	...
                	EventGameLoop event = new EventGameLoop();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading Gothaj...");
    ...
    private void runGameLoop() throws IOException
    {
        ...
        if (this.isGamePaused && this.theWorld != null)
        {
            ...
            float f2 = this.fakeTimer.renderPartialTicks;
        ...
        {
            EventTimeDelay event = new EventTimeDelay();
            Client.INSTANCE.getEventBus().call(event);
        }
    ...
    public void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                ...
                {
                    case ENTITY:
                    	 AttackOrder.sendFixedAttack(thePlayer, this.objectMouseOver.entityHit);
                        break;
    ...
    public void clickMouseEvent()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                ...
                {
                    case ENTITY:
                    	AttackOrder.sendFixedAttackEvent(this.thePlayer, this.objectMouseOver.entityHit);
                        break;
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                {
                	BindHandler.handleKey(i, Ac.Mouse);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        BindHandler.handleKey(k, Ac.Keyboard);
