...
import vip.gothaj.client.event.events.EventRenderHotbar;
import vip.gothaj.client.event.events.EventRenderScoreboard;
...
public class GuiIngame extends Gui
{
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        ...
        {
        	EventRenderHotbar event = new EventRenderHotbar(this, partialTicks, sr);
