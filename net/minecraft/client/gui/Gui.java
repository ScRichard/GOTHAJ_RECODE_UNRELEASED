...
public class Gui
{
    ...
    public static void drawModalRectWithCustomSizedTexture(float x, float y, float u, float v, double width, double height, double width2, double height2)
    {
        float f = (float) (1.0F / width2);
        float f1 = (float) (1.0F / height2);
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
