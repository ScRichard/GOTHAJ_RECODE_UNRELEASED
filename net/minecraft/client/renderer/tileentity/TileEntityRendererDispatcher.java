...
import vip.gothaj.client.event.events.EventRenderTileEntity;
...
public class TileEntityRendererDispatcher
{
    ...
    public void renderTileEntityAt(TileEntity tileEntityIn, float partialTicks)
    {
        this.renderTileEntityAt(tileEntityIn, tileEntityIn.getPos().getX(), tileEntityIn.getPos().getY(), tileEntityIn.getPos().getZ(), partialTicks, -1);
    }

    public void renderTileEntityAt(TileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage)
    {
    	EventRenderTileEntity event = new EventRenderTileEntity(tileEntityIn);
