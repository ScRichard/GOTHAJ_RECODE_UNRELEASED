...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
    	if (ViaLoadingBase.getInstance().getTargetVersion().isOlderThan(ProtocolVersion.v1_16)) {
    		PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    	}
        ...
        if (ViaLoadingBase.getInstance().getTargetVersion().isNewerThanOrEqualTo(ProtocolVersion.v1_16)) {
        	this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(packetIn.x, packetIn.y, packetIn.z, packetIn.yaw, packetIn.pitch, false));
        }else {
