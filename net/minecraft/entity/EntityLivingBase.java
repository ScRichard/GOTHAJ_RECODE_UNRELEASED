...
public abstract class EntityLivingBase extends Entity
{
    ...
    public float rotationYawHead, rotationPitchHead;
    public float prevRotationYawHead, prevRotationPitchHead;
    ...
    public void onLivingUpdate()
    {
        ...
        double offset = 0.005;
        if(ViaLoadingBase.getInstance().getTargetVersion().isNewerThan(ProtocolVersion.v1_8) && !Minecraft.getMinecraft().isSingleplayer()) {
        	offset = 0.003;
        }
