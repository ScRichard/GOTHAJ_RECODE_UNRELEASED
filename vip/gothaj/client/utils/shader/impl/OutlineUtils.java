...
public class OutlineUtils extends ShaderRenderer {
    ...
    private Shader shader = new Shader(new ResourceLocation("gothaj/shaders/outline.frag"));
    
    private float radius = 1F, lastRadius = 2, copression;
	...
	public void execute(ShaderType type, float partialTicks) {
		if(type == ShaderType.Render3D) {
	        ...
	        shader.uniform1i("u_diffuse_sampler", 0);
	        shader.uniform1i("u_other_sampler", 20);
