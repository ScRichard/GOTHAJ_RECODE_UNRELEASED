...
public class FontUtils {
	...
	protected CharData[] charData = new CharData[65535];
	protected CharData[] boldChars = new CharData[65535];
	protected CharData[] italicChars = new CharData[65535];
	protected CharData[] boldItalicChars = new CharData[65535];
	protected Font font;
	...
	public void renderStringAligned(String text, double x, double y, int width, int color, boolean dropShadow)
    {
		double i = this.getWidth(this.bidiReorder(text));
        x = x + width - i;

        this.drawString(text, (float)x, (float)y, color, dropShadow, 9f);
    }
